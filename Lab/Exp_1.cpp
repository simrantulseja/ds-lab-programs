...
cin>>size_;
array1 ob(size_);
cout<<"enter 1 for entering values"<<endl<<"2 for inserting element at specific position"<<endl;
cout<<"3 for deletion"<<endl<<"4 for searching"<<endl<<"5 to display"<<endl<<"0 to exit"<<endl;
cin>>ch;
while (ch!=0)
{
switch(ch)
